...
/// <summary>
/// An equality comparer for <see cref="ErrorOr{TValue}"/> that compares errors without considering their order.
/// </summary>
...
/// </code>
/// </example>
public sealed class ErrorOrUnorderedEqualityComparer<TValue> : IEqualityComparer<ErrorOr<TValue>>
{
    private ErrorOrUnorderedEqualityComparer()
    {
    }
    ...
    /// </summary>
    public static ErrorOrUnorderedEqualityComparer<TValue> Instance { get; } = new();
    ...
    public bool Equals(ErrorOr<TValue> x, ErrorOr<TValue> y)
    {
    ...
    /// </remarks>
    public int GetHashCode(ErrorOr<TValue> obj)
    {
        if (!obj.IsError)
        {
