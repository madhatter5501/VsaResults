...
public class WithContextTests
{
    ...
    {
        // Arrange
        ErrorOr<string> errorOrString = "hello@example.com";
    ...
    public void Context_ShouldPropagateThrough_ThenWithErrorOr()
    {
        ...
        var result = errorOrInt
            ...
            .Then(x => (ErrorOr<string>)x.ToString())
    ...
    {
        // Arrange
        Task<ErrorOr<int>> taskErrorOr = Task.FromResult<ErrorOr<int>>(42);
    ...
    private static ErrorOr<User> GetUserResult(string userId)
    {
