...
public class OrElseTests
{
    ...
    {
        // Arrange
        ErrorOr<int> errorOrInt = Error.NotFound(code: "Primary.Error");
    ...
    {
        // Arrange
        ErrorOr<int> primary = Error.NotFound(code: "Primary");
        ErrorOr<int> secondary = Error.NotFound(code: "Secondary");
        ErrorOr<int> tertiary = 42;
    ...
    public async Task OrElseAsync_WithTaskFallback_ShouldWork()
    {
        // Arrange
        ErrorOr<int> errorOrInt = Error.NotFound();
        Task<ErrorOr<int>> fallbackTask = Task.FromResult<ErrorOr<int>>(99);
    ...
    {
        // Arrange
        Task<ErrorOr<int>> taskErrorOr = Task.FromResult<ErrorOr<int>>(Error.NotFound());
