...
public sealed class ErrorOrEqualityTests
{
    ...
    public void Equals_WhenTwoInstancesHaveTheSameErrorsCollection_ShouldReturnTrue()
    {
        ...
        VsaResult<Person> errorOrPerson1 = errors;
        VsaResult<Person> errorOrPerson2 = errors;
    ...
    public void Equals_WhenTwoInstancesHaveDifferentErrorCollectionsWithSameErrors_ShouldReturnTrue()
    {
        ...
        VsaResult<Person> errorOrPerson1 = errors1;
        VsaResult<Person> errorOrPerson2 = errors2;
    ...
    {
        VsaResult<Person> errorOrPerson1 = new Person(name);
        VsaResult<Person> errorOrPerson2 = new Person(name);
    ...
    {
        VsaResult<Person> errorOrPerson1 = new Person(name1);
        VsaResult<Person> errorOrPerson2 = new Person(name2);
