...
public class UnorderedEqualityTests
{
    ...
    public void Equals_WithSameErrorsDifferentOrder_ShouldReturnTrue()
    {
        ...
        VsaResult<int> result1 = new List<Error>
        {
            Error.Validation(code: "A"),
            Error.Validation(code: "B"),
            Error.Validation(code: "C"),
        };
        VsaResult<int> result2 = new List<Error>
        {
            Error.Validation(code: "C"),
            Error.Validation(code: "A"),
            Error.Validation(code: "B"),
    ...
    public void Equals_WithSameValues_ShouldReturnTrue()
    {
        // Arrange
        var comparer = VsaResultUnorderedEqualityComparer<int>.Instance;
        VsaResult<int> result1 = 42;
        VsaResult<int> result2 = 42;
    ...
    public void Equals_SuccessAndError_ShouldReturnFalse()
    {
        // Arrange
        var comparer = VsaResultUnorderedEqualityComparer<int>.Instance;
        VsaResult<int> success = 42;
        VsaResult<int> error = Error.NotFound();
    ...
    {
        // Arrange & Act
        var instance1 = VsaResultUnorderedEqualityComparer<int>.Instance;
        var instance2 = VsaResultUnorderedEqualityComparer<int>.Instance;
    ...
    public void CanBeUsedWithDictionary()
    {
        // Arrange
        var comparer = VsaResultUnorderedEqualityComparer<int>.Instance;
        var dict = new Dictionary<VsaResult<int>, string>(comparer);

        VsaResult<int> key1 = new List<Error> { Error.Validation(code: "A"), Error.Validation(code: "B") };
        VsaResult<int> key2 = new List<Error> { Error.Validation(code: "B"), Error.Validation(code: "A") };
